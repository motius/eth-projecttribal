...
cp keys/nikolay.json keys/lorenzo.json testing/1/data/keystore
cp keys/nikolay.json keys/lorenzo.json testing/2/data/keystore
cp keys/nikolay.json keys/lorenzo.json testing/3/data/keystore

tilix -a session-add-right -e "bootnode --nodekey=./boot.key -verbosity 9 -nat any"
...
geth --datadir testing/1/data --networkid 1900 --bootnodes enode://dcb403ce5241b7454a5fa2ba52c7def7df7759b720f74036ead066ac56e3aa4e3be40f678347a5a9c1bd1b4d3a26b9a0823111392f87e5606c125126916b9a6d@127.0.0.1:30301 --port 30303 console --rpc --rpcaddr 0.0.0.0 --rpcapi "db,eth,net,web3,personal"
